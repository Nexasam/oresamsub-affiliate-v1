...
trait WalletTransactionLogs
{
    public function log_wallet_transactions($array): void
    {
        ...
        // ADMIN_WALLET_CREDITING, USER_WALLET_CREDITING, CRYSTALPAY_WALLET_FUNDING
        ...
        // Only attach affiliate_id if provided
        if (isset($array['affiliate_id'])) {
            $data['affiliate_id'] = $array['affiliate_id'];
        }
