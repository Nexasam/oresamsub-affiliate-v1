          ...
          <div class="col-span-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  @if (isset($dynamic_acct_alert))
                    <div class="bg-success/10 border border-success/10 alert text-success" role="alert">
                     
                       @php
                           $details = $dynamic_acct_alert;

                            // Set your timezone (Nigeria is Africa/Lagos)
                            ...
                            // Target time
                            $target = new DateTime($details['expire_at']);
                      ...
                      <p>Bankname: {{ $details['bank_name'] }}</p>
                      <p>Bank code: {{ $details['bank_code'] }}</p>
                      ...
                      <p>Account number is invalid in:{{ number_format($totalMinutes) }} minutes</p>
                        ...
                        <div class="box-body">
                            <div class="grid grid-cols-10 gap-4"> 
                                  <div class="col-span-7 justify-center">
                                    <strong>{{__('messages.Please note that you are expected to pay exact same amount to the dynamic account generated...')}}</strong>
                                    <form action="{{ route('user.dynamic_accounts.generate') }}" method="POST">
                                      @csrf
                                      <div class="mb-4">
                                          <label class="ti-form-label mb-0">Amount:</label>
                                          <input type="text" value="{{$funding_option->id}}" name="funding_option_id" id="funding_option_id">
                                          <input required type="number" class="my-auto ti-form-input" id="amount_to_fund" name="amount_to_fund" value="{{ old('amount_to_fund') }}" placeholder="amount">
                                      </div>
                              
                                      <div class="mb-4">
                                          <button type="submit" class="ti-btn ti-btn-primary w-full">Generate Dynamic Account to send to</button>
                                      </div>
                                    </form>
                                  </div>
