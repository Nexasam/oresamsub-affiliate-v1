          ...
          <div class="col-span-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h5 class="box-title">{{ auth()->user()->role->role_name == 'Admin' ? 'TEST' : '' }}  Data Transactions v2</h5>
                </div>
                                    ...
                                    <div class="box-body">
                                      <h3><strong> Wallet balance: &#8358;{{  number_format($user_details->main_wallet,2) }}</strong></h3>
                                        ...
                                        <form>
                                            ...
                                            <div class="grid w-full lg:w-1/2 lg:grid-cols-1 space-y-4 lg:space-y-0">
                                              ...
                                              @endif --}}
                                                ...
                                                <div id="show_data_details" class="hidden">
                                                    ...
                                                    {{-- single_select --}}
                                                    <div id="product_plan_category_div" class="hidden mt-2">
