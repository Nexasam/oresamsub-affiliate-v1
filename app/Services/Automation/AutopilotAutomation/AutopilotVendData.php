...
class AutopilotVendData{
    ...
    private $automation_slug = 'autopilot';
    ...
    public function __construct($mobile_number,$plan_id,$amount){
        ...
        $this->api_key = Automation::where('slug','autopilot')->first()->api_public_key;
        $this->api_password = Automation::where('slug','autopilot')->first()->api_password;
    ...
    public function buyAirtime(){
        ...
        CURLOPT_URL => 'https://simhosting.autopilot.ng/api/v1/vend/airtime',
