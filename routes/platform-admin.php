...
use App\Http\Controllers\PlatformAdmin\ProviderConnectionCatalogueController;
...
Route::prefix('admin')->name('platform-admin.')->group(function () {
    ...
    Route::middleware('auth:platform_admin')->group(function () {
        ...
        Route::get('provider-connections/catalogue', [ProviderConnectionCatalogueController::class, 'index'])->name('provider-connections.catalogue.index');
        Route::post('provider-connections/catalogue', [ProviderConnectionCatalogueController::class, 'store'])->name('provider-connections.catalogue.store');
        Route::put('provider-connections/catalogue/{providerConnection}', [ProviderConnectionCatalogueController::class, 'update'])->name('provider-connections.catalogue.update');
        ...
        Route::post('provider-connections/{connection}/promote-legacy-configuration', [ParentProviderConnectionController::class, 'promoteLegacyConfiguration'])->name('provider-connections.promote-legacy-configuration');
