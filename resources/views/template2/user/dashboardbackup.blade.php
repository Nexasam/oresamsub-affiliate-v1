...
<div class="max-w-screen">
     ...
     <div class="grid grid-cols-12 h-20 border-t border-b border-r border-gray-300">
        ...
        <div class="col-span-6 md:col-span-10 flex items-center justify-between md:justify-between md:pl-10 md:pr-1">
            ...
            <div class="hidden md:block">
                <h3 class=" font-bold text-lg">Hello Elizabeth,</h3>
                <p class=" font-light text-sm">Welcome to datahub</p>
            </div>
            ...
            <div class=" flex items-center justify-between space-x-1 md:space-x-10">
     ...
     <div class="relative grid grid-cols-12 h-screen ">
        ...
        <div class="col-span-12 md:col-span-10">
            <!-- HELLO USER -->
            <div class="bg-[{{$site_secondary_color}}] flex items-center justify-center h-12 ">
             <p class="text-center  font-normal text-sm">You can now enjoy free data bonus by verifying your phone number  <a href="" class=" font-bold underline text-[{{$site_primary_color}}]">here</a></p>
            </div>
            <div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 items-center px-2 md:px-0 py-6 gap-4 md:gap-3 text-sm ">
               ...
               <div class="md:flex items-center p-2 md:p-6 rounded-lg border border-gray-300 space-x-1 md:space-x-4">
                ...
                <div class="w-full flex-col text-sm  rounded-lg border border-gray-300">
                    <div class="p-2 md:p-4">
                        <p>Account Number
                        <span class="font-bold">23457890</span>
                        </p>
                        <p>FOX Data hub - First bank </p>
                    </div>
                    <button type="button" class="w-full rounded-b-lg text-white bg-[{{$site_primary_color}}] hover:bg-[{{$site_secondary_color}}] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-4 md:px-6 py-2 md:py-2 mr-0 md:mr-4 text-center ">copy</button>
