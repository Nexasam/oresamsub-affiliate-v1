    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <div class="flex items-center">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
            @if ($site_logo)
            <img class="w-12 h-14 md:w-20 md:mx-auto pb-2" src="{{ config('app.url').'assets/landing_page_assets/img/site_logo/'.$site_logo->image_name }}" alt="">
...
<div class="grid grid-cols-12 md:h-20 border-t border-b border-r border-gray-300" >
    ...
    <div   class="hidden px-2 md:px-0 md:border-r md:border-gray-300 col-span-0 md:col-span-2 w-full md:flex items-center justify-between md:justify-start ">
        <div class="flex items-center justify-start md:hidden">
            ...
            {{-- <p class=" font-light text-xs">Welcome to {{config('app.name')}}</p> --}}
        </div>
        ...
        @if ($site_logo)
            <img class="w-12 md:w-20 md:mx-auto pb-2" src="{{ config('app.url').'assets/landing_page_assets/img/site_logo/'.$site_logo->image_name }}" alt="">
