                  ...
                  <div class="mt-3">
                        ...
                        {{-- <table  class="ti-custom-table ti-custom-table-head ti-striped-table ti-custom-table-hover ">
                            ...
                            <tbody>
                              ...
                              @foreach ($bulk_data_wallets as $bulk_data_wallet)
                                  ...
                                  <td>{{ number_format($bulk_data_wallet->bulk_wallet_balance_mb) }}</td>
                                  <td>{{ number_format($bulk_data_wallet->alltime_bulk_wallet_balance_mb) }}</td>
                    ...
                    <div id="pills-with-brand-color-3" class="hidden" role="tabpanel" aria-labelledby="pills-with-brand-color-item-3">
                      <div class="overflow-auto" style="font-size: 10px;">
                        {{-- <table  class="ti-custom-table ti-custom-table-head ti-striped-table ti-custom-table-hover ">
                            <thead> --}}
                              <table  class="ti-custom-table ti-custom-table-head">    
                                ...
                                <tr>
                                    ...
                                    <th>Product Plan Category Wallet</th>
                                    <th>Main Wallet Before</th>
                                    <th>Amount Spent</th>
                                    <th>Main Wallet After</th>
                                    <th>Data Balance Before(MB)</th>
                                    <th>Data Balance After(MB)</th>
                                    <th>Data Value Bought(MB)</th>
                                    <th>Data Value Bought(GB)</th>
                                    <th>Data Value Bought(TB)</th>
                                    <th>MB Measurement</th>
                            ...
                            <tbody>
                              @php
                                  $count = 1;
                              @endphp
                              @foreach ($user_bulk_data_purchases as $user_bulk_data_purchase)
                                  <tr>
                                  <td>{{ $count++ }}</td>
                                  <td>{{ $user_bulk_data_purchase->bulk_data_plan_name }}</td>
                                  <td>{{ $user_bulk_data_purchase->product_plan_category->product_plan_category_name }}</td>
                                  <td>{{ number_format($user_bulk_data_purchase->main_wallet_before) }}</td>
                                  <td>{{ number_format($user_bulk_data_purchase->amount_spent) }}</td>
                                  <td>{{ number_format($user_bulk_data_purchase->main_wallet_after) }}</td>
                                  <td>{{ number_format($user_bulk_data_purchase->wallet_data_balance_before) }}</td>
                        ...
                        {{ $user_bulk_data_purchases->links() }} 
                      </div>                
                    </div>
                    ...
                    <div id="pills-with-brand-color-4" class="hidden" role="tabpanel" aria-labelledby="pills-with-brand-color-item-4">
                      ...
                      <div class="overflow-auto" style="font-size: 10px;">
                              ...
                              <table  id="data_wallet_transactions_table" class="ti-custom-table ti-custom-table-head">    
                                <thead class="bg-gray-50 dark:bg-black/20">
                                  <tr>
                                    <th>ID</th>
                                    {{-- <th>User</th> --}}
