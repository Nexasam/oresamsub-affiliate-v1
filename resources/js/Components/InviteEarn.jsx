...
export default function InviteEarn({ referralLink, secondaryColor }) {
  ...
  return (
    <div
      className="mt-4 rounded-xl shadow-md overflow-hidden"
      style={{ border: `1px solid ${secondaryColor}` }}
    >
      {/* Accordion Toggle */}
      <button
        onClick={() => setInviteOpen(!inviteOpen)}
        className="w-full flex justify-between items-center text-white px-3 py-2 text-xs font-semibold shadow-sm hover:shadow-md transition-all duration-300"
        style={{
          background: `linear-gradient(to right, ${secondaryColor}, ${secondaryColor})`,
        }}
      >
