...
<head>
    ...
    <style>
        :root {
            --brand: {{ $site_primary_color ?? '#6366f1' }};
            --brand-hover: {{ $site_landing_page_hover_color ?? '#4f46e5' }};
        }
...
<nav x-data="{ open: false, scrolled: false }"
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        <div class="flex items-center gap-3">
            ...
            @else
                <span class="font-bold text-xl text-indigo-600">{{ $site_logo_alt ?? 'OurBrand' }}</span>
            @endif
        </div>

        <div class="hidden md:flex items-center space-x-6">
            <a href="#home" class="hover:text-indigo-600 font-medium">Home</a>
            <a href="#about" class="hover:text-indigo-600 font-medium">About</a>
            <a href="#services" class="hover:text-indigo-600 font-medium">Services</a>
            <a href="#reviews" class="hover:text-indigo-600 font-medium">Testimonials</a>
...
<section id="home" class="relative flex flex-col justify-center items-center text-center text-white min-h-screen"
    ...
    <div data-aos="fade-up">
        ...
        <h1 class="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-500 bg-clip-text text-transparent animate-gradient">
...
<section id="about" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 px-6 items-center">
        ...
        <div data-aos="fade-left">
            <h6 class="text-indigo-600 uppercase mb-2 font-semibold">About Us</h6>
...
<section id="services" class="py-20 bg-white text-center">
    <div class="max-w-6xl mx-auto px-6">
        <h6 class="text-indigo-600 uppercase mb-2 font-semibold">Our Services</h6>
        <h2 class="text-3xl md:text-4xl font-bold mb-10">Features you'll love</h2>
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div class="p-8 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2" data-aos="zoom-in">
                <i class="bx bx-wifi text-4xl text-indigo-500 mb-3"></i>
            ...
            <div class="p-8 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2" data-aos="zoom-in" data-aos-delay="100">
                <i class="bx bx-phone-call text-4xl text-indigo-500 mb-3"></i>
            ...
            <div class="p-8 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-2" data-aos="zoom-in" data-aos-delay="200">
                <i class="bx bx-tv text-4xl text-indigo-500 mb-3"></i>
...
<section id="services" class="py-20 bg-white text-center">
    <div class="max-w-6xl mx-auto px-6">
        <h6 class="text-indigo-600 uppercase mb-2 font-semibold">Our Pricing</h6>
        <h2 class="text-3xl md:text-4xl font-bold mb-10">We have affordable pricingg you will love</h2>
            @php
            $grouped = [];
            ...
            <div x-data="{ tab: '{{ array_key_first($grouped) }}' }"
                class="max-w-7xl mx-auto px-4 sm:px-8 py-12 space-y-10 bg-gray-50 dark:bg-gray-950">
                ...
                @foreach($grouped as $category => $networks)
                    <div x-show="tab === '{{ $category }}'" x-cloak x-transition.opacity.duration.400ms
                        class="space-y-10">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                                    @foreach($categories as $catName => $plans)
                                        @foreach($plans as $plan)
                                            ...
                                            <div
                                                class="relative p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm 
                                                    hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 ease-in-out group"
                                                ...
                                                <!-- Pricing -->
                                                <div class="mt-3 font-extrabold text-xl"
                                                    style="color: {{ $accent }};">
                                                    @if($showPercent)
                                                ...
                                                <div class="mt-4">
                                                    <a
                                                        class="w-full py-2 rounded-full text-sm font-medium border transition-all duration-300
                                                        ...
                                                        {{-- @click="$dispatch('select-plan', {{ json_encode($plan) }}) --}}
                                                        >
                                                        Buy Now
                                                </a>
                                                </div>
...
<section id="reviews" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6 text-center">
        <h6 class="text-indigo-600 uppercase font-semibold mb-2">Testimonials</h6>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up">
            @foreach($testimonials ?? [
                ...
                <div class="bg-white rounded-2xl shadow-md hover:shadow-xl p-6 text-left transition transform hover:-translate-y-2">
...
<!-- Footer -->
<footer class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-8 text-center">
