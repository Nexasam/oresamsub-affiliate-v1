...
@section('content')
      ...
      <div class="main-content">
        ...
        <div class="block justify-between page-header md:flex">
            {{-- <div>
                <h3 class="text-gray-700 hover:text-gray-900 dark:text-gray-900 dark:hover:text-white text-2xl font-medium"> Buy: {{ $plan_category->product_plan_category_name }}</h3>
            </div>
                                        ...
                                        <form>
                                            ...
                                            <div class="grid w-full lg:w-1/2 lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                                ...
                                                <div class="space-y-2">
                                                  ...
                                                  {{-- <input type="number" class="my-auto ti-form-input" id="amount" name="amount_for_airtime_category" value="{{ $amount }}" placeholder="Enter amount to recharge">  --}} 
                                                  <input type="number" class="my-auto ti-form-input" id="amount" name="amount" value="{{ $amount }}" placeholder="Enter amount to recharge"> 
