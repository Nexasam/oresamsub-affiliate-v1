...
class UserController extends Controller {
 public function index(Request $request) {
  ...
  $users=User::withoutGlobalScope('affiliate')->whereIn('affiliate_id',$affiliateIds)->with(['affiliate:id,name','role:id,role_name','user_plan:id,plan_name,plan_level'])->withCount('transactions')
