                  ...
                  <div class="mt-3">
                    <div id="pills-with-brand-color-1" class="hidden" role="tabpanel" aria-labelledby="pills-with-brand-color-item-1">
                              ...
                              <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                <div class="ti-modal-content">
                                  ...
                                  <div class="ti-modal-body">
                                    <p class="mt-1 text-gray-800 dark:text-white/70">Metre Number:</p>
                                    <input type="text" value="" id="metre_numberr" name="metre_numberr"> <br>
                                    <hr>
                                    <br>
                      ...
                      <div class="overflow-auto" style="font-size: 10px;">    
                              <table  id="electricty_transactions_table" class="ti-custom-table ti-custom-table-head">    
