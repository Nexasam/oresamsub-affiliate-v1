...
<section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <div class="mt-6 grid gap-4 md:grid-cols-3">
        ...
        <a href="{{ route('parent-admin.provider-connections.index') }}" class="rounded-2xl border border-slate-200 p-5 transition hover:border-blue-300 hover:bg-blue-50"><span class="text-sm font-semibold text-blue-600">API CONNECTIONS</span><h3 class="mt-2 text-lg font-bold">Open providers</h3><p class="mt-1 text-sm text-slate-500">Configure encrypted credentials, endpoints and response mappings.</p></a>
    </div>
</section>
@endsection
