...
@section('content')
      ...
      <div class="main-content">
        ...
        <div class="block justify-between page-header md:flex">
            <div>
                <h3 class="text-gray-700 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white text-2xl font-medium"> Profile Settings for <strong>{{ $user->first_name.' '.$user->last_name }}  ({{ $user->role->role_name }})</strong></h3>
            </div>
                            ...
                            <div class="my-4">
                                <div class="grid lg:grid-cols-2 gap-6 mb-6">
                                    <div class="space-y-2">
                                        ...
                                        <input type="number" class="my-auto ti-form-input" name="amount" id="amount" placeholder="">
