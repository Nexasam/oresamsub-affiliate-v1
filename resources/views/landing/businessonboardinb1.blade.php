...
<div class="h-screen flex overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    <div class="flex-1 flex flex-col overflow-hidden ">
      ...
      <div x-data="{ step: 1 }" class="mb-10 bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Business Onboarding</h2>
        <div class="space-y-10">
            <!-- Step 1 -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-blue-600 dark:text-blue-400">Step 1: Basic Details</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" placeholder="Full Name" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Business Name" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="email" placeholder="Email Address" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Phone Number" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="RC Number" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Business Category" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                </div>
            </div>
            <!-- Step 2 -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-blue-600 dark:text-blue-400">Step 2: Directors</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" placeholder="Director 1 Name" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Director 1 Phone" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="email" placeholder="Director 1 Email" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Director 2 Name" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Director 2 Phone" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="email" placeholder="Director 2 Email" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                </div>
            </div>
            <!-- Step 3 -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-blue-600 dark:text-blue-400">Step 3: Verifications</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" placeholder="Business Address" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Tax ID" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="TIN" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="NIN" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Bank Name" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="text" placeholder="Account Number" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                </div>
            </div>
            <!-- Step 4 -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-blue-600 dark:text-blue-400">Step 4: Document Uploads</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="file" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="file" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="file" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="file" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
                    <input type="file" class="px-4 py-2 border rounded dark:bg-gray-700 dark:text-white">
