          ...
          <div class="col-span-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h5 class="box-title">Coupon Codes</h5>

                  
                <button class="hs-dropdown-toggle ti-btn ti-btn-success"  data-hs-overlay="#hs-vertically-centered-modal12">Add Coupon</button>
                              ...
                              <div class="grid w-full lg:w-full lg:grid-cols-1 gap-6 space-y-4 lg:space-y-0">
                                  <div class="grid grid-cols-1 gap-2">
                                      <div class="">
                                          ...
                                          <input value="" name="title" type="text" required class="my-auto ti-form-input" min="0" placeholder="title">
                                      </div>
  
                                      <div class="">
                                          <label class="ti-form-label mb-0">Code</label>
                                          <input value="" name="code" type="text" class="my-auto ti-form-input" min="0" placeholder="code">
                                      </div>

                                      <div class="">
                                        <label class="ti-form-label mb-0">Amount</label>
                                        <input value="" name="amount" type="text" class="my-auto ti-form-input" min="0" placeholder="amount">
                                      </div>
                                      ...
                                      <div class="">
                                        ...
                                        <select id="product_slug" name="product_slug" required class="my-auto ti-form-select">
                                      ...
                                      <div class="">
                                        <label class="ti-form-label mb-0">Transaction Metrics</label>
                                        <select id="transaction_metrics" name="transaction_metrics" required class="my-auto ti-form-select">
                                            <option selected value="before">Customers whose last transaction was on or before the transaction metrics date</option>
                                            <option value="after">Customers whose last transaction was on or after the transaction metrics date</option>
                                         </select>
                                      </div>

                                      <div class="">
                                        <label class="ti-form-label mb-0">Transaction Metrics Date</label>
                                        <input value="" name="transaction_metrics_date" type="date" class="my-auto ti-form-input" min="0" placeholder="metrics date">
                                      </div>

                                      <div class="">
                                        <label class="ti-form-label mb-0">Slots</label>
                                        <input value="" name="slots" type="text" class="my-auto ti-form-input" min="0" placeholder="slots">
                                      </div>

                                  </div>

                                  <div class="space-y-2">
                                      <button type="submit" class="ti-btn ti-btn-primary w-full">Create  Coupon Code</button>
                                  </div>
                            ...
                            <tbody>
                              ...
                              @foreach ($coupon_codes as $cc)
                                <tr>
                                  ...
                                  <td>{{ $cc->code }}</td>
                                  <td>{!! '&#8358;'.$cc->amount !!}</td>
                                  <td>{{ 'Customers with last transaction on or '.$cc->transaction_metrics.' '.$cc->transaction_metrics_date }}</td>
                                  <td>{!! $cc->product_plan_category->product_plan_category_name.'<strong>('.$cc->product_plan_category->network->network_name.')</strong>' !!}</td>
                                  ...
                                  <td>{{ $cc->created_at }}</td>
                                  {{-- <td>  --}}
                                  {{-- <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-primary" data-hs-overlay="#hs-vertically-centered-modal{{$cc->id}}">
                                    Details
                                  </button>  --}}
                                  {{-- </td> --}}
