...
@section('content')
      ...
      <div class="main-content">
        ...
        <div class="block justify-between page-header md:flex">
            {{-- <div>
                <h3 class="text-gray-700 hover:text-gray-900 dark:text-gray-900 dark:hover:text-white text-2xl font-medium"> Buy  <strong>{{ $plan_category->product_plan_category_name }}</strong> </h3>
            </div>
                                ...
                                <div class="ti-modal-content">
                                  ...
                                  <div class="ti-modal-body">
                                    ...
                                    <select name="product_plan_category_filter" id="product_plan_category_filter">
                                        ...
                                        @foreach ($product_plan_categories as $plan_categoryyy)
                                          <option value="{{ $plan_categoryyy->id}}">{{ $plan_categoryyy->product_plan_category_name }}</option>   
                                        @endforeach
                                    </select>
                                    <br>
                                    <hr>
