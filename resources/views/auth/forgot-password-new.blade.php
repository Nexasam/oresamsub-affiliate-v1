    ...
    <div class="w-full max-w-md px-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="px-6 sm:px-8 pt-8">
                ...
                <p class="text-center text-sm text-gray-600 dark:text-gray-400 mb-6">
                    {{ __('messages.No problem') }}. {{ __('messages.Enter your email address and we will send you a password reset link') }}.
                </p>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('password.email') }}" class="px-6 sm:px-8 pb-8">
                @csrf
        ...
        <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-200 dark:border-blue-800/30 rounded-lg">
            <p class="text-xs text-blue-800 dark:text-blue-400">
                <strong>💡 Tip:</strong> {{ __('messages.Please check your spam folder if you do not receive the email') }}.
            </p>
        </div>
    </div>
